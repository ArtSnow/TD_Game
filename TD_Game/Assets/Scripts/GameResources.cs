...

{
    ...
    private void Awake()
    {
        ...
        towers[0] = new TowerStats("First", gameAssets.towerSprites[0], 70f, 25, .8f, 25, 1.1f, 1.05f, 1.05f);
        towers[1] = new TowerStats("Second", gameAssets.towerSprites[1], 100f, 100, 2.5f, 25, 1.05f, 1.1f, 1.05f);
        towers[2] = new TowerStats("Third", gameAssets.towerSprites[2], 50f, 10, .2f, 25, 1.05f, 1.05f, 1.1f);
        towers[3] = new TowerStats("Locked", gameAssets.towerSprites[3], 0, 0, 0, -1, 0, 0, 0);
        towers[4] = new TowerStats("Locked", gameAssets.towerSprites[4], 0, 0, 0, -1, 0, 0, 0);
        enemies = new EnemyStats[5];
        enemies[0] = new EnemyStats("Skeleton", gameAssets.monsterSprites[0], 2, 80, 10, 1, 1, 1, 30f, 1);
        enemies[1] = new EnemyStats("Orc", gameAssets.monsterSprites[1], 3, 200, 20, 2, 2, 3, 10f, 2);
        enemies[2] = new EnemyStats("Bat", gameAssets.monsterSprites[2], 1, 40, 20, 2, 2, 0, 70f, 2);
        enemies[3] = new EnemyStats("Locked", gameAssets.monsterSprites[3], 0, 0, -1, 0, 0, 0, 0, 0);
        enemies[4] = new EnemyStats("Locked", gameAssets.monsterSprites[4], 0, 0, -1, 0, 0, 0, 0, 0);
    }
